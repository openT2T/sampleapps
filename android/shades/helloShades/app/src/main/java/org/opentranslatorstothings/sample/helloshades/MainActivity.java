...
package org.opentranslatorstothings.sample.helloshades;
...
public class MainActivity extends AppCompatActivity {
    ...
    private static final int MESSAGE_OPENALL = 1;
    private static final int MESSAGE_CLOSEALL = 2;
    ...
    private static final int MESSAGE_NOSHADES = 8;

    private static final String LOG_TAG = "HelloShades";
    ...
    private Handler mUIHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case MESSAGE_OPENALL:
                    Toast.makeText(MainActivity.this,R.string.open_all_confirmation,Toast.LENGTH_SHORT).show();
                    break;
                case MESSAGE_CLOSEALL:
                    Toast.makeText(MainActivity.this,R.string.close_all_confirmation,Toast.LENGTH_SHORT).show();
                    break;
                case MESSAGE_NOSHADES:
                    Toast.makeText(MainActivity.this,R.string.msg_noshades,Toast.LENGTH_SHORT).show();
                    break;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button allonButton = (Button) findViewById(R.id.open_all_button);
        allonButton.setOnClickListener(
                new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        mBusHandler.sendEmptyMessage(BusHandler.OPENALL);
                        mUIHandler.sendEmptyMessage(MESSAGE_OPENALL);
                    }
                }
        );

        Button alloffButton = (Button) findViewById(R.id.close_all_button);
        alloffButton.setOnClickListener(
                new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        mBusHandler.sendEmptyMessage(BusHandler.CLOSEALL);
                        mUIHandler.sendEmptyMessage(MESSAGE_CLOSEALL);
                    }
                }
        );
    ...
    class BusHandler extends Handler {
         ...
         */
        private static final String SERVICE_NAME = "org.OpenT2T.Sample.SuperPopular.Shades";
        private static final String SERVICE_PATH = "/Service";
        private static final short CONTACT_PORT=42;

        private BusAttachment mBus;
        private ProxyBusObject mProxyObj;
        private HelloShadesInterface mShadesInterface;
        ...
        public static final int OPENALL = 4;
        public static final int CLOSEALL = 5;
        ...
        public void handleMessage(Message msg) {
                 ...
                 */
                     ...
                     */
                        mProxyObj =  mBus.getProxyBusObject(SERVICE_NAME,
                                SERVICE_PATH,
                                sessionId.value,
                                new Class<?>[] { HelloShadesInterface.class });

                    /* We make calls to the methods of the AllJoyn object through one of its interfaces. */
                        mShadesInterface =  mProxyObj.getInterface(HelloShadesInterface.class);
             ...
             */
                case OPENALL: {
                    try {
                        if (mShadesInterface != null) {
                            mUIHandler.sendEmptyMessage(MESSAGE_OPENALL);
                            mShadesInterface.open();
                        } else {
                            mUIHandler.sendEmptyMessage(MESSAGE_NOSHADES);
                        }
                    }
                    catch (BusException ex) {
                        logException("HelloShadesInterface.open()", ex);
                    }
                    break;
                }
                case CLOSEALL: {
                    try {
                        if (mShadesInterface != null) {
                            mUIHandler.sendEmptyMessage(MESSAGE_CLOSEALL);
                            mShadesInterface.close();
                        } else {
                            mUIHandler.sendEmptyMessage(MESSAGE_NOSHADES);
                        }
                    }
                    catch (BusException ex) {
                        logException("HelloShadesInterface.close()", ex);
                    }
                    break;
                }
                default:
