 ...
 */
@BusInterface(name = "org.OpenT2T.Sample.SuperPopular.Lamp")
public interface HelloLampInterface {
     ...
     */
    @BusMethod
    void TurnOn() throws BusException;
    void TurnOff() throws BusException;
    void SetBrightness(int brightness) throws BusException;
}
