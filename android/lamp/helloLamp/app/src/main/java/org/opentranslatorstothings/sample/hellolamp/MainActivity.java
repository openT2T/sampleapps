...
package org.opentranslatorstothings.sample.hellolamp;
...
public class MainActivity extends AppCompatActivity {
    ...
    private static final int MESSAGE_TURNON = 1;
    private static final int MESSAGE_TURNOFF = 2;
    ...
    private static final int MESSAGE_NOLAMPS = 8;

    private static final String LOG_TAG = "HelloLamp";
    ...
    private Handler mUIHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case MESSAGE_TURNON:
                    Toast.makeText(MainActivity.this,R.string.all_on_confirmation,Toast.LENGTH_SHORT).show();
                    break;
                case MESSAGE_TURNOFF:
                    Toast.makeText(MainActivity.this,R.string.all_off_confirmation,Toast.LENGTH_SHORT).show();
                    break;
                case MESSAGE_NOLAMPS:
                    Toast.makeText(MainActivity.this,R.string.msg_nolamps,Toast.LENGTH_SHORT).show();
                    break;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button allonButton = (Button) findViewById(R.id.allon_button);
        allonButton.setOnClickListener(
                new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        mBusHandler.sendEmptyMessage(BusHandler.TURNON);
                        mUIHandler.sendEmptyMessage(MESSAGE_TURNON);
                    }
                }
        );

        Button alloffButton = (Button) findViewById(R.id.alloff_button);
        alloffButton.setOnClickListener(
                new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        mBusHandler.sendEmptyMessage(BusHandler.TURNOFF);
                        mUIHandler.sendEmptyMessage(MESSAGE_TURNOFF);
                    }
                }
        );
    ...
    class BusHandler extends Handler {
         ...
         */
        private static final String SERVICE_NAME = "org.OpenT2T.Sample.SuperPopular.Lamp";
        private static final short CONTACT_PORT=42;

        private BusAttachment mBus;
        private ProxyBusObject mProxyObj;
        private HelloLampInterface mLampInterface;
        ...
        public static final int TURNON = 4;
        public static final int TURNOFF = 5;
        ...
        public void handleMessage(Message msg) {
                 ...
                 */
                     ...
                     */
                        mProxyObj =  mBus.getProxyBusObject(SERVICE_NAME,
                                "/SimpleService",
                                sessionId.value,
                                new Class<?>[] { HelloLampInterface.class });

                    /* We make calls to the methods of the AllJoyn object through one of its interfaces. */
                        mLampInterface =  mProxyObj.getInterface(HelloLampInterface.class);
             ...
             */
                case TURNON: {
                    try {
                        if (mLampInterface != null) {
                            mUIHandler.sendEmptyMessage(MESSAGE_TURNON);
                            mLampInterface.TurnOn();
                        } else {
                            mUIHandler.sendEmptyMessage(MESSAGE_NOLAMPS);
                        }
                    }
                    catch (BusException ex) {
                        logException("HelloLampInterface.TurnOn()", ex);
                    }
                    break;
                }
                case TURNOFF: {
                    try {
                        if (mLampInterface != null) {
                            mUIHandler.sendEmptyMessage(MESSAGE_TURNOFF);
                            mLampInterface.TurnOff();
                        } else {
                            mUIHandler.sendEmptyMessage(MESSAGE_NOLAMPS);
                        }
                    }
                    catch (BusException ex) {
                        logException("HelloLampInterface.TurnOff()", ex);
                    }
                    break;
                }
                default:
