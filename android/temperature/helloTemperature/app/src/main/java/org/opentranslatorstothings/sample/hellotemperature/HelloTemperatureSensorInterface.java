 ...
 */
@BusInterface(name = "org.OpenT2T.Sample.SuperPopular.TemperatureSensor")
public interface HelloTemperatureSensorInterface {
     ...
     */
    @BusMethod
    double getCurrentTemperature() throws BusException;
    @BusMethod
    double getTemperatureTrend() throws BusException;
}
