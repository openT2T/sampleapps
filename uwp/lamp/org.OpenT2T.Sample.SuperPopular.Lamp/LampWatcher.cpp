...
void LampWatcher::UnregisterFromBus()
{
    ...
    {
        PCSTR interfaces[] = { "org.OpenT2T.Sample.SuperPopular.Lamp" };
    ...
    _In_ const alljoyn_msgarg aboutDataArg)
{
    ...
    if (alljoyn_aboutobjectdescription_hasinterface(objectDescription, "org.OpenT2T.Sample.SuperPopular.Lamp"))
    {
        AllJoynServiceInfo^ args = ref new AllJoynServiceInfo(
            AllJoynHelpers::MultibyteToPlatformString(name),
            AllJoynHelpers::GetObjectPath(objectDescription, "org.OpenT2T.Sample.SuperPopular.Lamp"),
            port);
        Added(this, args);
    }
