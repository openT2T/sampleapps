...
public:
    ...
    Windows::Foundation::IAsyncOperation<LampTurnOnResult^>^ TurnOnAsync();
    // Call the turnOff method
    Windows::Foundation::IAsyncOperation<LampTurnOffResult^>^ TurnOffAsync();
    // Call the setBrightness method
    Windows::Foundation::IAsyncOperation<LampSetBrightnessResult^>^ SetBrightnessAsync(_In_ uint32 interfaceMemberBrightness);
