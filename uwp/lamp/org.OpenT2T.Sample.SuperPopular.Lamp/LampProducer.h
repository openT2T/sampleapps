...
private:
    ...
    static void CallTurnOnHandler(_Inout_ alljoyn_busobject busObject, _In_ alljoyn_message message);
    static void CallTurnOffHandler(_Inout_ alljoyn_busobject busObject, _In_ alljoyn_message message);
    static void CallSetBrightnessHandler(_Inout_ alljoyn_busobject busObject, _In_ alljoyn_message message);
