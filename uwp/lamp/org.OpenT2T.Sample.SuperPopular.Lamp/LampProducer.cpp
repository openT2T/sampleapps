...
void LampProducer::CallTurnOnHandler(_Inout_ alljoyn_busobject busObject, _In_ alljoyn_message message)
{
    ...
    if (producer->Service != nullptr)
    {
        ...
        LampTurnOnResult^ result = create_task(producer->Service->TurnOnAsync(callInfo)).get();
        create_task([](){}).then([=]
        {
            int32 status;
...
void LampProducer::CallTurnOffHandler(_Inout_ alljoyn_busobject busObject, _In_ alljoyn_message message)
{
    auto source = SourceObjects.find(busObject);
    if (source == SourceObjects.end())
    {
    ...
    if (producer->Service != nullptr)
    {
        ...
        LampTurnOffResult^ result = create_task(producer->Service->TurnOffAsync(callInfo)).get();
        create_task([](){}).then([=]
        {
            int32 status;
...
void LampProducer::CallSetBrightnessHandler(_Inout_ alljoyn_busobject busObject, _In_ alljoyn_message message)
{
    auto source = SourceObjects.find(busObject);
    if (source == SourceObjects.end())
    {
    ...
    if (producer->Service != nullptr)
    {
        ...
        LampSetBrightnessResult^ result = create_task(producer->Service->SetBrightnessAsync(callInfo, inputArg0)).get();
        create_task([](){}).then([=]
        {
            int32 status;
...
void LampProducer::CallErrorSignalHandler(_In_ const alljoyn_interfacedescription_member* member, _In_ alljoyn_message message)
{
...
void LampProducer::Start()
{
    ...
    alljoyn_interfacedescription interfaceDescription = alljoyn_busattachment_getinterface(AllJoynHelpers::GetInternalBusAttachment(m_busAttachment), "org.OpenT2T.Sample.SuperPopular.Lamp");
    ...
    result = AddMethodHandler(
        ...
        "turnOn", 
        [](alljoyn_busobject busObject, const alljoyn_interfacedescription_member* member, alljoyn_message message) { UNREFERENCED_PARAMETER(member); CallTurnOnHandler(busObject, message); });
    if (result != ER_OK)
    {
        StopInternal(result);
        return;
    ...
    result = AddMethodHandler(
        interfaceDescription, 
        "turnOff", 
        [](alljoyn_busobject busObject, const alljoyn_interfacedescription_member* member, alljoyn_message message) { UNREFERENCED_PARAMETER(member); CallTurnOffHandler(busObject, message); });
    if (result != ER_OK)
    {
        StopInternal(result);
        return;
    ...
    result = AddMethodHandler(
        interfaceDescription, 
        "setBrightness", 
        [](alljoyn_busobject busObject, const alljoyn_interfacedescription_member* member, alljoyn_message message) { UNREFERENCED_PARAMETER(member); CallSetBrightnessHandler(busObject, message); });
    if (result != ER_OK)
    {
        StopInternal(result);
        return;
...
PCSTR org::OpenT2T::Sample::SuperPopular::Lamp::c_LampIntrospectionXml = "<interface name=\"org.OpenT2T.Sample.SuperPopular.Lamp\">"
"  <!-- Turn on the light -->"
"  <method name=\"turnOn\" />"
"  <!-- Turn off the light -->"
"  <method name=\"turnOff\" />"
